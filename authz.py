...
ROLE_PERMISSIONS = OrderedDict([
    ...
    ('developer', ['read','create_service','update_service','delete_service','run_service_staging','show_report']),
    ('tester', ['read','run_service_staging','show_report']),
])
...
def _trans_role_developer():
    return _('Developer')

def _trans_role_tester():
    return _('Tester')
def trans_role(role):
